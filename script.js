    ...
    if (contactForm) {
        ...
        const validateInput = (input) => {
            ...
            if (isRequired && !value) {
                ...
                const fieldName = label ? label.textContent.replace('*', '').trim() : (name || 'This field');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a62ee85e-045b-40bb-a2e0-1f9d9acf9679',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a62ee85e-045b-40bb-a2e0-1f9d9acf9679';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a62ee85e-045b-40bb-a2e0-1f9d9acf9679';
